...
<img src="https://img.shields.io/badge/Last%20Update-{{LAST_UPDATE}}%20ago-blueviolet">
<img src="https://img.shields.io/badge/Countries-{{COUNTRIES_COUNT}}%2B-orange">

</br>

<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/http.txt">
  <img src="https://img.shields.io/badge/HTTP-{{HTTP_COUNT}}%20PROXIES-brightgreen">
</a>
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/socks4.txt">
  <img src="https://img.shields.io/badge/SOCKS4-{{SOCKS4_COUNT}}%20PROXIES-orange">
</a>
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/socks5.txt">
  <img src="https://img.shields.io/badge/SOCKS5-{{SOCKS5_COUNT}}%20PROXIES-blue">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-{{AVG_LATENCY}}ms-yellow)
![Lowest](https://img.shields.io/badge/Lowest%20Latency-{{LST_LATENCY}}ms-brightgreen)
...
- **🌍 Multi-Country**: Proxies from **{{COUNTRIES_COUNT}}+ countries** with per-country breakdowns
- **🚦 Multi-Protocol**:
  - **HTTP**: {{HTTP_COUNT}} proxies (CONNECT method for HTTPS sites — strict SSL)
  - **SOCKS4**: {{SOCKS4_COUNT}} proxies
  - **SOCKS5**: {{SOCKS5_COUNT}} proxies
- **⚡ Low Latency**: avg {{AVG_LATENCY}}ms, best {{LST_LATENCY}}ms
