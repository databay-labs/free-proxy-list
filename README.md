...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/http.txt">
  <img src="https://img.shields.io/badge/HTTP-195%20PROXIES-brightgreen">
</a>
...
![Latency](https://img.shields.io/badge/Avg%20Latency-3303ms-yellow)
...
- **Multi-Country**: Proxies from **64+ countries** 🌍
- **Protocol Support**:
  - **HTTP**: 195 proxies (with strict SSL)
  - **SOCKS5**: 3552 proxies (with strict SSL)
