...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/socks5.txt">
  <img src="https://img.shields.io/badge/SOCKS5-3136%20PROXIES-blue">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-3471ms-yellow)
...
- **Multi-Country**: Proxies from **57+ countries** 🌍
- **Protocol Support**:
  - **HTTP**: 177 proxies (with strict SSL)
  - **SOCKS5**: 3136 proxies (with strict SSL)
