...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/https.txt">
  <img src="https://img.shields.io/badge/HTTPS-1976%20PROXIES-yellow">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-338,19805696621773ms-yellow) 
...
- **Multi-Country**: Proxies from **150+ countries** 🌍
- **Blazing Fast**: Curated for speed ⚡
- **Protocol Support**:
  - **HTTP**: 2453 proxies
  - **HTTPS**: 1976 proxies (no MITM certificate trust needed 🔒)
  - **SOCKS5**: 1380 proxies
