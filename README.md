...
<img src="https://img.shields.io/badge/UPDATED:%200.71%20second(s)%20ago-8A2BE2">
</br>
...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/https.txt">
  <img src="https://img.shields.io/badge/HTTPS-1124%20PROXIES-yellow">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-378,26736842105265ms-yellow) 
...
- **Multi-Country**: Proxies from **84+ countries** 🌍
- **Blazing Fast**: Curated for speed ⚡
- **Protocol Support**:
  - **HTTP**: 1475 proxies
  - **HTTPS**: 1124 proxies (no MITM certificate trust needed 🔒)
  - **SOCKS5**: 1072 proxies
