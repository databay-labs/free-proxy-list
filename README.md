...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/https.txt">
  <img src="https://img.shields.io/badge/HTTPS-2415%20PROXIES-yellow">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-367,92581930912314ms-yellow) 
...
- **Multi-Country**: Proxies from **178+ countries** 🌍
- **Blazing Fast**: Curated for speed ⚡
- **Protocol Support**:
  - **HTTP**: 1889 proxies
  - **HTTPS**: 2415 proxies (no MITM certificate trust needed 🔒)
  - **SOCKS5**: 1745 proxies
