...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/http.txt">
  <img src="https://img.shields.io/badge/HTTP-70%20PROXIES-brightgreen">
</a>
...
- **Multi-Country**: Proxies from **60+ countries** 🌍
- **Protocol Support**:
  - **HTTP**: 70 proxies (with strict SSL)
  - **SOCKS5**: 1003 proxies (with strict SSL)
