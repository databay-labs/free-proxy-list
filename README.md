...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/https.txt">
  <img src="https://img.shields.io/badge/HTTPS-2784%20PROXIES-yellow">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-354,81306306306305ms-yellow) 
...
- **Multi-Country**: Proxies from **165+ countries** 🌍
- **Blazing Fast**: Curated for speed ⚡
- **Protocol Support**:
  - **HTTP**: 1942 proxies
  - **HTTPS**: 2784 proxies (no MITM certificate trust needed 🔒)
  - **SOCKS5**: 1827 proxies
