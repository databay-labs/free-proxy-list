...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/http.txt">
  <img src="https://img.shields.io/badge/HTTP-54%20PROXIES-brightgreen">
</a>
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/socks5.txt">
  <img src="https://img.shields.io/badge/SOCKS5-1380%20PROXIES-blue">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-2379ms-yellow)
![Lowest](https://img.shields.io/badge/Lowest%20Latency-48ms-brightgreen)
...
- **Multi-Country**: Proxies from **52+ countries** 🌍
- **Protocol Support**:
  - **HTTP**: 54 proxies (with strict SSL)
  - **SOCKS5**: 1380 proxies (with strict SSL)
