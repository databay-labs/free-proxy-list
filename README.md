...
<a href="https://github.com/databay-labs/free-proxy-list/raw/refs/heads/master/socks5.txt">
  <img src="https://img.shields.io/badge/SOCKS5-1226%20PROXIES-blue">
</a>

</br>

![Latency](https://img.shields.io/badge/Avg%20Latency-2359ms-yellow)
...
- **Multi-Country**: Proxies from **50+ countries** 🌍
- **Protocol Support**:
  - **HTTP**: 48 proxies (with strict SSL)
  - **SOCKS5**: 1226 proxies (with strict SSL)
